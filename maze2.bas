10PRINT"WIDTH OF MAZE (MAX 30)";\INPUTW\IFW<31THEN20\PRINT"TOO WIDE."\GOTO10
20PRINT"HEIGHT OF MAZE (MAX 30)";\INPUTH\IFH<31THEN30\PRINT"TOO WIDE."\GOTO20
30PRINT\H1=H*2-2\H2=H1-1\W1=W*2-2\W2=W1-1\DIMA(58,58),X(900),Y(900)\FORI=1TOW2STEP2
31FORJ=0TOH1STEP2\A(I,J)=1\NEXTJ\NEXTI\FORI=0TOW1STEP2\FORJ=1TOH2STEP2\A(I,J)=1
32NEXTJ\NEXTI\A(X,Y)=2\RANDOMIZE\FORN=2TOH*W\GOSUB1100\A(X1,Y1)=0\A(X2,Y2)=2
33X=X2\Y=Y2\S=S+1\X(S)=X\Y(S)=Y\NEXTN\GOSUB1200\STOP
...
1200GOSUB1400\FORI=0TOH1STEP2\PRINT"!";\FORJ=1TOW2STEP2\PRINT"   ";CHR$(A(J,I)+32);
1201NEXTJ
1210PRINT"   !"\IFI=H1THEN1220\PRINT"+";\FORJ=0TOW1STEP2\C=A(J,I+1)*13+32
1211PRINTCHR$(C);CHR$(C);CHR$(C);"+";\NEXTJ\PRINT
