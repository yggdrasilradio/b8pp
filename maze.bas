1W=8\H=8\H1=H*2-2\H2=H1-1\W1=W*2-2\W2=W1-1\DIMA(14,14),X(64),Y(64)\FORI=1TOW2STEP2
2FORJ=0TOH1STEP2\A(I,J)=1\NEXTJ\NEXTI\FORI=0TOW1STEP2\FORJ=1TOH2STEP2\A(I,J)=1
3NEXTJ\NEXTI\A(X,Y)=2\RANDOM\FORN=2TOH*W\GOSUB1100\A(X1,Y1)=0\A(X2,Y2)=2
4X=X2\Y=Y2\S=S+1\X(S)=X\Y(S)=Y\NEXTN\GOSUB1200\STOP
